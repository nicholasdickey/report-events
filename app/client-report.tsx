                ...
                <div className="Sidebar basis-1/5 border-r-2 border-inherit h-full p-4" >
                    <form className="max-w-sm mx-auto">
                        ...
                        <div className="flex items-center mb-4 mt-4">
                            <input onChange={(event) => { console.log("setBot=", event.target.checked); setBot(event.target.checked ? true : false) }} id="include-bots" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
